...
class UserAdapter(
    ...
    override fun onBindViewHolder(holder: Vh, position: Int) {
        ...
        holder.rol.text =
            if (item.rol == "ADMIN")
                holder.itemView.context.getString(R.string.role_admin)
            else
                holder.itemView.context.getString(R.string.role_user)
    ...
    class Vh(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val rol: Chip = itemView.findViewById(R.id.textRol)
